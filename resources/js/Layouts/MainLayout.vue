...
<template>
    <div id="MainLayout" class="w-full h-screen">
        ...
        <div
            v-if="$page.url !== '/'"
            id="TopNavUser"
            class="md:hidden fixed flex items-center justify-between z-30 w-full bg-white h-[61px] border-b-gray-300"
        >
        ...
        <div
            id="SideNav"
            class="fixed h-full bg-white xl:w-[280px] w-[80px] md:block hidden border-r border-r-gray-300 z-50"
        >
            <Link href="/">
                <img
            ...
            <div class="px-3">
                ...
                <Notification iconString="Notifications" class="mb-4" />
        ...
        >
            ...
            <!-- The :class is a dynamic binding in Vue, which allows you to conditionally apply classes based on the component's data, props, or computed properties.
            You can pass strings, arrays, or objects to the :class attribute to determine which classes should be applied. -->
            ...
            >
                ...
                <div
                    class="flex items-center justify-between max-w-[300px] py-3"
                >
